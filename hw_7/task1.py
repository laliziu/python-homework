...
vowel = lambda letter: letter in {"а", "о", "у", "ы", "э", "я", "е", "ё", "ю", "и"}
vowel_quantity = list(len(list(filter(vowel, i))) for i in text_in_list)
print(vowel_quantity)
print ('Парам пам-пам') if len(set(vowel_quantity)) == 1 else ('Пам парам')
